...
public final class UBowsCommand implements CommandExecutor, TabCompleter {
    ...
    public List<String> onTabComplete(final CommandSender sender, final Command command, final String alias, final String[] args) {
        ...
        if (args.length == 1) {
            ...
            return StringUtil.copyPartialMatches(args[1], Arrays.asList("destructionBow", "playerBow", "teleportBow", "explosiveBow", "waterBow", "lavaBow", "lightningBow", "mobBow"), new ArrayList<>());
